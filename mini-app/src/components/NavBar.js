...
const TABS = [
    ...
    { id: 'new', label: 'New', icon: '+', big: true },
    { id: 'strategies', label: 'Agents', icon: '◉' },
    { id: 'activity', label: 'Activity', icon: '≡' },
];
export default function NavBar({ screen, onNav, agentCount }) {
    ...
    return (_jsx("nav", { style: {
            ...
            return (_jsxs("button", { onClick: () => onNav(tab.id), style: {
                    flex: 1, background: 'none', border: 'none',
                    cursor: 'pointer', padding: '10px 4px 6px',
                    display: 'flex', flexDirection: 'column',
                    alignItems: 'center', gap: 3, position: 'relative',
                }, children: [tab.big ? (_jsx("div", { style: {
                        ...
                        }, children: "+" })) : (_jsxs("span", { style: { fontSize: 20, lineHeight: 1, color: active ? theme.accent : theme.sub, position: 'relative' }, children: [tab.icon, badge > 0 && (_jsx("span", { style: {
